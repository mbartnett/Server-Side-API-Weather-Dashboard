    ...
    fetch(apiURL)
        ...
        .then(function (currentWeather) {
            ...
            currentSection.innerHTML =
                `<h2><span id="current-city">${currentWeather.name}</span>, <span id="current-date">${dayjs.unix(currentWeather.dt).format('MMMM D, YYYY')}</span> ${parseWeatherEmoji(currentWeather.weather[0].icon)}
                //  <img style="display:inline-block;" src="${iconURL}" />
                 </h2>
